"""
Django settings for criminology_db project.
...
SECRET_KEY = 'django-insecure-jkhv&c%dgui)n6zggqa46_yxz@+2ht3(7e=7ec&c#!pb--+j!('
...
ROOT_URLCONF = 'criminology_db.urls'
...
WSGI_APPLICATION = 'criminology_db.wsgi.application'
