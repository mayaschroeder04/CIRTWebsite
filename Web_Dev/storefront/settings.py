...
SECRET_KEY = 'django-insecure-m_q+^^n_r44bt%b00c$87d-ceukc8ri-74n6v2h4@i&e)d@d_^'
...
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'mainpage/static'), ]  # Replace your_app_name
